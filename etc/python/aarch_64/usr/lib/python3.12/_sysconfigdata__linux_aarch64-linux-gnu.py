...
build_time_vars = {'ABIFLAGS': '',
 ...
 'ALT_SOABI': 0,
 'ANDROID_API_LEVEL': 0,
 'AR': '/home/mersad/Documents/Embedded-Linux/Buildroot/buildroot-2024.11/output/host/bin/aarch64-buildroot-linux-gnu-gcc-ar',
 'ARFLAGS': 'rcs',
 'BASECFLAGS': '-fno-strict-overflow -Wsign-compare',
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '/etc/python/aarch64/usr/bin',
 'BINLIBDEST': '/etc/python/aarch64/usr/lib/python3.12',
 'BLDLIBRARY': '-L. -lpython3.12',
 'BLDSHARED': '/home/mersad/Documents/Embedded-Linux/Buildroot/buildroot-2024.11/output/host/bin/aarch64-buildroot-linux-gnu-gcc '
              '-shared',
 'BOOTSTRAP_HEADERS': '\\',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'BYTESTR_DEPS': '\\',
 'CC': '/home/mersad/Documents/Embedded-Linux/Buildroot/buildroot-2024.11/output/host/bin/aarch64-buildroot-linux-gnu-gcc',
 'CCSHARED': '-fPIC',
 'CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall '
           '-D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64  '
           '-O2 -g0 -D_FORTIFY_SOURCE=1',
 ...
 'CONFIG_ARGS': "'--target=aarch64-buildroot-linux-gnu' "
                ...
                "'--enable-shared' '--disable-lib2to3' '--without-readline' "
                "'--disable-curses' '--with-expat=none' '--disable-sqlite3' "
                "'--prefix=/etc/python/aarch64/usr' "
                "'--exec-prefix=/etc/python/aarch64/usr' '--without-ensurepip' "
                "'--without-cxx-main' "
                "'--with-build-python=/home/mersad/Documents/Embedded-Linux/Buildroot/buildroot-2024.11/output/host/bin/python3' "
                "'--with-system-ffi' '--disable-pydoc' "
                "'--disable-test-modules' '--disable-tk' '--disable-idle3' "
                "'--disable-pyc-build' 'build_alias=x86_64-pc-linux-gnu' "
                "'host_alias=aarch64-buildroot-linux-gnu' "
                "'target_alias=aarch64-buildroot-linux-gnu' "
                "'PKG_CONFIG=/home/mersad/Documents/Embedded-Linux/Buildroot/buildroot-2024.11/output/host/bin/pkg-config' "
                "'CC=/home/mersad/Documents/Embedded-Linux/Buildroot/buildroot-2024.11/output/host/bin/aarch64-buildroot-linux-gnu-gcc' "
                "'CFLAGS=-D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE "
                "-D_FILE_OFFSET_BITS=64  -O2 -g0 -D_FORTIFY_SOURCE=1' "
                "'LDFLAGS=' 'CPPFLAGS=-D_LARGEFILE_SOURCE "
                "-D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64' "
                "'CPP=/home/mersad/Documents/Embedded-Linux/Buildroot/buildroot-2024.11/output/host/bin/aarch64-buildroot-linux-gnu-cpp'",
 'CONFINCLUDEDIR': '/etc/python/aarch64/usr/include',
 'CONFINCLUDEPY': '/etc/python/aarch64/usr/include/python3.12',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/home/mersad/Documents/Embedded-Linux/Buildroot/buildroot-2024.11/output/build/python3-3.12.7/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/home/mersad/Documents/Embedded-Linux/Buildroot/buildroot-2024.11/output/build/python3-3.12.7/lcov-report',
 ...
 'DESTDIRS': '/etc/python/aarch64/usr /etc/python/aarch64/usr/lib '
             '/etc/python/aarch64/usr/lib/python3.12 '
             '/etc/python/aarch64/usr/lib/python3.12/lib-dynload',
 'DESTLIB': '/etc/python/aarch64/usr/lib/python3.12',
 'DESTPATH': '',
 'DESTSHARED': '/etc/python/aarch64/usr/lib/python3.12/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'EXE': '',
 'EXEMODE': 755,
 'EXENAME': '/etc/python/aarch64/usr/bin/python3.12',
 'EXPORTSFROM': '',
 'EXPORTSYMS': '',
 'EXTRATESTOPTS': '',
 'EXTRA_CFLAGS': '',
 ...
 'FREEZE_MODULE': '/home/mersad/Documents/Embedded-Linux/Buildroot/buildroot-2024.11/output/host/bin/python3 '
                  './Programs/_freeze_module.py',
 'FREEZE_MODULE_BOOTSTRAP': '/home/mersad/Documents/Embedded-Linux/Buildroot/buildroot-2024.11/output/host/bin/python3 '
                            './Programs/_freeze_module.py',
 ...
 'INCLDIRSTOMAKE': '/etc/python/aarch64/usr/include '
                   '/etc/python/aarch64/usr/include '
                   '/etc/python/aarch64/usr/include/python3.12 '
                   '/etc/python/aarch64/usr/include/python3.12',
 'INCLUDEDIR': '/etc/python/aarch64/usr/include',
 'INCLUDEPY': '/etc/python/aarch64/usr/include/python3.12',
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': '/home/mersad/Documents/Embedded-Linux/Buildroot/buildroot-2024.11/output/host/bin/aarch64-buildroot-linux-gnu-gcc '
             '-shared',
 'LDVERSION': '3.12',
 'LIBC': '',
 'LIBDEST': '/etc/python/aarch64/usr/lib/python3.12',
 'LIBDIR': '/etc/python/aarch64/usr/lib',
 'LIBEXPAT_A': 'Modules/expat/libexpat.a',
 'LIBEXPAT_CFLAGS': '-I./Modules/expat -fno-strict-overflow -Wsign-compare '
                    '-DNDEBUG -g -O3 -Wall -D_LARGEFILE_SOURCE '
 ...
 'LIBHACL_CFLAGS': '-I./Modules/_hacl/include -D_BSD_SOURCE -D_DEFAULT_SOURCE '
                   ...
                   '-D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64 -fPIC -fPIC',
 'LIBHACL_HEADERS': '\\',
 ...
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/etc/python/aarch64/usr/lib/pkgconfig',
 'LIBPL': '/etc/python/aarch64/usr/lib/python3.12/config-3.12-aarch64-linux-gnu',
 'LIBPYTHON': '',
 ...
 'LIBS': '-ldl  -lpthread',
 'LIBSUBDIRS': 'asyncio \\',
 'LINKCC': '/home/mersad/Documents/Embedded-Linux/Buildroot/buildroot-2024.11/output/host/bin/aarch64-buildroot-linux-gnu-gcc',
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/etc/python/aarch64/usr/lib/python3.12',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 1,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/etc/python/aarch64/usr/share/man',
 ...
 'MODBUILT_NAMES': 'array  _asyncio  _bisect  _contextvars  _csv  _heapq  '
                   ...
                   'audioop  math  cmath  _statistics  _datetime  binascii  '
                   '_md5  _sha1  _sha2  _sha3  _blake2  _elementtree  '
 ...
 'MODSHARED_NAMES': 'array _asyncio _bisect _contextvars _csv _heapq _json '
                    ...
                    'math cmath _statistics _datetime binascii _md5 _sha1 '
                    '_sha2 _sha3 _blake2 _elementtree _multibytecodec '
                    'unicodedata fcntl grp mmap _posixsubprocess resource '
                    'select _socket spwd syslog termios _posixshmem '
                    '_multiprocessing _ctypes xxlimited xxlimited_35',
 ...
 'MODULE__CTYPES_LDFLAGS': '-L/home/mersad/Documents/Embedded-Linux/Buildroot/buildroot-2024.11/output/host/bin/../aarch64-buildroot-linux-gnu/sysroot/usr/lib '
                           '-lffi -ldl',
 ...
 'PYTHONPATH': '',
 'PYTHON_FOR_BUILD': '_PYTHON_PROJECT_BASE=/home/mersad/Documents/Embedded-Linux/Buildroot/buildroot-2024.11/output/build/python3-3.12.7 '
                     '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
                     'PYTHONPATH=./Lib '
                     '_PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__linux_aarch64-linux-gnu '
                     '_PYTHON_SYSCONFIGDATA_PATH=$(shell test -f '
                     'pybuilddir.txt && echo '
                     '/home/mersad/Documents/Embedded-Linux/Buildroot/buildroot-2024.11/output/build/python3-3.12.7/`cat '
                     'pybuilddir.txt`) '
                     '/home/mersad/Documents/Embedded-Linux/Buildroot/buildroot-2024.11/output/host/bin/python3',
 'PYTHON_FOR_BUILD_DEPS': '',
 'PYTHON_FOR_FREEZE': '/home/mersad/Documents/Embedded-Linux/Buildroot/buildroot-2024.11/output/host/bin/python3',
 'PYTHON_FOR_REGEN': '',
 'PYTHON_HEADERS': '\\',
 'PYTHON_OBJS': '\\',
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g '
                             ...
                             '-D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64  '
                             '-O2 -g0 -D_FORTIFY_SOURCE=1 -std=c11 -Wextra '
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': '',
 'SCRIPTDIR': '/etc/python/aarch64/usr/lib',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': '_PYTHON_PROJECT_BASE=/home/mersad/Documents/Embedded-Linux/Buildroot/buildroot-2024.11/output/build/python3-3.12.7 '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=./Lib '
               '_PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__linux_aarch64-linux-gnu '
               ...
               '/home/mersad/Documents/Embedded-Linux/Buildroot/buildroot-2024.11/output/host/bin/python3',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': '_PYTHON_PROJECT_BASE=/home/mersad/Documents/Embedded-Linux/Buildroot/buildroot-2024.11/output/build/python3-3.12.7 '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=./Lib '
               '_PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__linux_aarch64-linux-gnu '
               '_PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && '
 ...
 'VERSION': '3.12',
 'WASM_ASSETS_DIR': './etc/python/aarch64/usr',
 'WASM_STDLIB': './etc/python/aarch64/usr/lib/python3.12/os.py',
 'WHEEL_PKG_DIR': '',
 'WINDOW_HAS_FLAGS': 0,
 ...
 'abs_builddir': '/home/mersad/Documents/Embedded-Linux/Buildroot/buildroot-2024.11/output/build/python3-3.12.7',
 'abs_srcdir': '/home/mersad/Documents/Embedded-Linux/Buildroot/buildroot-2024.11/output/build/python3-3.12.7',
 'datarootdir': '/etc/python/aarch64/usr/share',
 'exec_prefix': '/etc/python/aarch64/usr',
 'prefix': '/etc/python/aarch64/usr',
 'srcdir': '.'}
